...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2021 at 01:41 AM
...
(7, '2020-10-31', 30000.00, 4, 'Monthly', 30000.00, 0.00, 0, 1200.00, 'M0076', '2020-11-30', 1),
(8, '2020-12-30', 15000.00, 4, 'Daily', 18000.00, 120.00, 5, 0.00, 'D0010', '2020-12-31', 1);
...
(7, '2020-12-30', 320.00, 0.00, 36800.00, 2, '2021-03-31', 0.00);
...
(1, '2021', '03', '194900.00', '3200.00', '2021-03-29'),
...
--
ALTER TABLE `loan`
  MODIFY `loan_no` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
